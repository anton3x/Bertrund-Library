...
namespace Definitivo.Areas.Identity.Pages.Account.Manage
{
    public class EnableAuthenticatorModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [StringLength(7, ErrorMessage = "A '{0}' deve ter entre {2} e {1} caracteres.", MinimumLength = 6)]
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            StatusMessage = "A sua aplicação de autenticação foi verificada.";
        ...
        private async Task LoadSharedKeyAndQrCodeUriAsync(Perfil user)
        {
